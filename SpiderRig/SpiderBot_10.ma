...
//Name: SpiderBot_10.ma
//Last modified: Sat, Mar 26, 2022 01:54:09 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "UUID" "46E3A309-4D5E-C54C-7C61-8F9EB9544B36";
createNode transform -s -n "persp";
	rename -uid "2C7FB34D-47D8-3F54-99F3-53B1CD23A427";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4706343705748548 10.966107194197564 22.708590650664242 ;
	setAttr ".r" -type "double3" 706.46164623112179 -9000.5999999964133 -4.1001585833680014e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "113807D5-483A-E7F6-4060-27B347736CC2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 23.604892330369868;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -3.8353027445911154 1.4142054858236504 -5.9146336168718356 ;
...
createNode joint -n "COG_Jnt";
	...
	setAttr ".t" -type "double3" 0 11.230008125305176 -0.71792304515838623 ;
...
createNode joint -n "IK_Leg_L1_Hip_Jnt" -p "IK_JNTS_GRP";
	...
	setAttr ".t" -type "double3" 2.1385097503662109 -1.3109302520751953 1.7122352123260498 ;
	setAttr ".r" -type "double3" -1.44262712328182e-15 1.3959002507485622e-14 4.3743568269417698e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -21.967871466670857 -40.317855187666517 31.94051005050526 ;
	setAttr ".ssc" no;
createNode joint -n "IK_Leg_L1_Knee_Jnt" -p "IK_Leg_L1_Hip_Jnt";
	...
	setAttr ".t" -type "double3" 3.949177989905186 2.2204460492503131e-16 6.6613381477509392e-16 ;
	setAttr ".r" -type "double3" 6.5162467829516527e-30 -1.4852256445796808e-15 3.4911113903233097e-14 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "IK_Leg_L3_Hip_Jnt" -p "IK_JNTS_GRP";
	...
	setAttr ".t" -type "double3" 1.9856199026107788 1.1239213943481445 -1.635863184928894 ;
	setAttr ".r" -type "double3" -7.5175813644445197e-07 9.4483743138940601e-07 -8.9140428358758125e-10 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "IK_Leg_R1_Hip_Jnt" -p "IK_JNTS_GRP";
	...
	setAttr ".t" -type "double3" -2.1397426128387451 -1.3109312057495117 1.7405495643615723 ;
	setAttr ".r" -type "double3" -1.4426251204332416e-15 1.3959002713514203e-14 4.3743874785781945e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -158.03210636331974 -40.317866698860016 148.05946735014933 ;
	setAttr ".ssc" no;
createNode joint -n "IK_Leg_R1_Knee_Jnt" -p "IK_Leg_R1_Hip_Jnt";
	...
	setAttr ".t" -type "double3" 3.9491785288562857 9.9920072216264089e-16 4.4408920985006262e-16 ;
	setAttr ".r" -type "double3" 2.288094985561782e-30 -2.599167387983829e-15 6.1094428130637757e-14 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "IK_Leg_R3_Hip_Jnt" -p "IK_JNTS_GRP";
	...
	setAttr ".t" -type "double3" -1.928486704826355 1.1059703826904297 -1.6611155271530151 ;
	setAttr ".r" -type "double3" 0.00029387121067836952 -0.00036692531645274155 -9.4600726547114229e-07 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 24.027229223126131 123.7036021584382 28.185398318348639 ;
	setAttr ".ssc" no;
createNode joint -n "IK_Leg_R3_Knee_Jnt" -p "IK_Leg_R3_Hip_Jnt";
	...
	setAttr ".t" -type "double3" 3.9491873390704435 -8.8817841970012523e-16 -1.9984014443252818e-15 ;
	setAttr ".r" -type "double3" -4.2365550436098334e-30 2.2891871044449312e-15 -3.5663724250854582e-14 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -3.6285057965034797 0.14080944423317474 -72.586395687538001 ;
	setAttr ".ssc" no;
...
createNode parentConstraint -n "Leg_R2_Knee_Geo_parentConstraint1" -p "Leg_R2_Knee_Geo";
	...
	setAttr ".tg[0].tor" -type "double3" -7.1284336412689215e-14 1.1006484190913919 
		78.0827530074273 ;
	setAttr ".lr" -type "double3" 8.5294152448896129e-14 2.2140030604305142e-16 -1.7472267170438002e-14 ;
...
createNode parentConstraint -n "Leg_R2_Toe2_Geo_parentConstraint1" -p "Leg_R2_Toe2_Geo";
	...
	setAttr ".lr" -type "double3" 0 3.3434164997694795 0 ;
...
createNode parentConstraint -n "Leg_R2_Ankle_Geo_parentConstraint1" -p "Leg_R2_Ankle_Geo";
	...
	setAttr ".lr" -type "double3" -1.3358329662146771e-13 -9.5416640443905724e-15 -1.9083328088781088e-14 ;
...
createNode parentConstraint -n "Leg_L2_Hip_Geo_parentConstraint1" -p "Leg_L2_Hip_Geo";
	...
	setAttr ".lr" -type "double3" 10.963004659987403 -0.60758743347354816 6.3250894900522026 ;
...
createNode parentConstraint -n "Leg_L2_Knee_Geo_parentConstraint1" -p "Leg_L2_Knee_Geo";
	...
	setAttr ".lr" -type "double3" 4.4800817081172255 -0.10146778831138761 2.5935790040511497 ;
...
createNode parentConstraint -n "Leg_L1_Hip_Geo_parentConstraint1" -p "Leg_L1_Hip_Geo";
	...
	setAttr ".lr" -type "double3" -5.6224794579936813e-15 -1.2722218725854067e-14 1.124495891598737e-15 ;
...
createNode parentConstraint -n "Leg_L1_Ankle_Geo_parentConstraint1" -p "Leg_L1_Ankle_Geo";
	...
	setAttr ".tg[0].tor" -type "double3" -2.5444437451708134e-14 129.78966681639167 
		88.166035940922924 ;
	setAttr ".lr" -type "double3" 2.8624992133171654e-14 -4.7670188018941725e-30 1.9083328088781101e-14 ;
...
createNode ikHandle -n "ikHandle1";
	...
	setAttr ".t" -type "double3" -4.8671164512634286 3.1112129688262939 3.7845475673675564 ;
	setAttr ".pv" -type "double3" -1.229012239939036 0.99060369051356911 1.228101478877426 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle2";
	rename -uid "097CFA39-4EF6-25BC-8385-A78C546E1B14";
	setAttr ".t" -type "double3" -7.6811256408691415 3.1247861385345441 -0.70590245723724465 ;
	setAttr ".pv" -type "double3" -1.6357994751018974 1.1505348376223505 0.020728354341565867 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle3";
	rename -uid "B387DBE9-4B89-8221-43A3-A58B33DB9D19";
	setAttr ".t" -type "double3" -4.0447393260557796 2.8131204334993765 -5.9374286099682241 ;
	setAttr ".pv" -type "double3" -0.92679228594795537 0.79739706350645279 -1.58278677711773 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle4";
	rename -uid "7CB6F6E3-4A8D-0403-276C-A1A30E0F49CB";
	setAttr ".t" -type "double3" 4.3753170967102015 3.1145036220550537 -6.5500197410583576 ;
	setAttr ".pv" -type "double3" 0.87367630995876044 0.92639779158236246 -1.5422311231356289 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle5";
	rename -uid "EE199E93-4321-DD8B-ADFD-B4A1181275B5";
	setAttr ".t" -type "double3" 7.6435046195983887 3.114503622055059 -0.77000832557583665 ;
	setAttr ".pv" -type "double3" 1.6418758781503229 1.1418198292674098 -0.022160285193013204 ;
	setAttr ".roc" yes;
createNode ikHandle -n "ikHandle6";
	rename -uid "6DE2E54E-42F8-7206-42E2-9182C26517C6";
	setAttr ".t" -type "double3" 4.9004306793212944 3.1112129688262939 3.721686124801642 ;
	setAttr ".pv" -type "double3" 1.2281015236429822 0.9906035858111818 1.2290122795984626 ;
	setAttr ".roc" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7AD00B8F-4991-6297-F150-9ABB78843259";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A19C257A-463D-DA59-6178-D0B56E72C6FA";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "46D75976-4D40-A17C-F847-05B6EFF8BA0A";
createNode displayLayerManager -n "layerManager";
	rename -uid "021B63C7-40E3-BD25-BE13-5292DD5695F3";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0D60D4A9-4761-9F1A-E8D2-4D800CF98E4B";
